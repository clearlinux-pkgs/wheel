...
Source0  : https://files.pythonhosted.org/packages/f9/85/120a5ad1565398efb1184eacaa597e925abbf8fff8cc748877add71257f1/wheel-0.34.1.tar.gz
...
%prep
%setup -q -n wheel-0.34.1
cd %{_builddir}/wheel-0.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580229908
