...
Source0  : https://files.pythonhosted.org/packages/ed/46/e298a50dde405e1c202e316fa6a3015ff9288423661d7ea5e8f22f589071/wheel-0.36.2.tar.gz
...
%prep
%setup -q -n wheel-0.36.2
cd %{_builddir}/wheel-0.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608096866
...
cp %{_builddir}/wheel-0.36.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/wheel/53aa128e9d6387e9bb9d945fdcbf1ab4d003baed
