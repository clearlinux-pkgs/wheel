...
Source0  : https://files.pythonhosted.org/packages/15/39/728ccb81172c73f14084948b2d4561d5e51649dcf4b21d1f207b7363b1d7/wheel-0.34.0.tar.gz
...
%prep
%setup -q -n wheel-0.34.0
cd %{_builddir}/wheel-0.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580143555
...
cp %{_builddir}/wheel-0.34.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/wheel/53aa128e9d6387e9bb9d945fdcbf1ab4d003baed
