...
%prep
%setup -q -n wheel-0.34.2
cd %{_builddir}/wheel-0.34.2
...
cp %{_builddir}/wheel-0.34.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/wheel/53aa128e9d6387e9bb9d945fdcbf1ab4d003baed
