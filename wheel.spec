...
Source0  : https://files.pythonhosted.org/packages/57/73/1911bfa69482de2a6327db4ca5eda87ae7599160018910007d6d6a1d3ada/wheel-0.36.0.tar.gz
...
%prep
%setup -q -n wheel-0.36.0
cd %{_builddir}/wheel-0.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606852942
